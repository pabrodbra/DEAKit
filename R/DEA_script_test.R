...
### Description: Script to manually test the functionality implemented in DEA_script.R
### ------------------------
...
rlf.filename <- file.path(rcc.directory, "NS_CancerPath_C2535.rlf")
...
# Enrich - All (computationally demanding)
...
# Enrich - Over (computationally demanding)
...
# Enrich - Under (computationally demanding)
...
MARKDOWN.PATH <- "reports/DEA_report_test.Rmd"
MARKDOWN.OUTPUT <- "../docs/DEA_report_test.html"
...
rmarkdown::render("reports/DEA_report_test.Rmd", output_file = MARKDOWN.OUTPUT)
