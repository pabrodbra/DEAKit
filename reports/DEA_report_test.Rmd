...
params:
  ...
  set_param: !r markdown.params$PARAM
---
...
plotFOV(eset = eset, metadata = metadata, fov.threshold = FOV.THRESHOLD,
...
plotBD(eset = eset, metadata = metadata, y.thresholds = BD.THRESHOLDS,
       comparison.key = key.label, legend.label = LABEL.OF.INTEREST)
```
